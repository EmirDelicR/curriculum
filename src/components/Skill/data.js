const descriptionData = [
  {
    ...
    content: [
      ...
      { name: 'css', data: ['Scss/Sass', 'Bootstrap', 'Bulma', 'Vuetify'] },
  ...
  },
  {
    ...
    content: [
      {
        name: 'programs',
        data: ['Node', 'Python', 'PHP']
      },
      { name: 'frameworks', data: ['Express', 'Django', 'CodeIgniter'] }
    ]
  },
  {
    type: 'description',
        ...
        content: [
          {
            ...
            data: {
              icon: 'fab fa-js',
              link:
                'https://github.com/EmirDelicR/Java-script-all/tree/master/ES6-Essentional',
        ...
        content: [
          {
            ...
            data: {
              icon: 'fab fa-sass',
              link:
                'https://github.com/EmirDelicR/Vue-js-all/tree/master/vue-with-scss',
        ...
        content: [
          {
            ...
            data: {
              ...
              link:
                'https://github.com/EmirDelicR/Vue-js-all/tree/master/tests-in-vue',
        ...
        content: [
          {
            ...
            data: {
              icon: 'fas fa-radiation',
              link:
                'https://github.com/EmirDelicR/Vue-js-all/tree/master/test-e2e-in-vue',
        ...
        content: [
          {
            ...
            data: {
              icon: 'fas fa-database',
              link:
                'https://github.com/EmirDelicR/Node-js-all/tree/master/17-GRAPHQL',
...
export { descriptionData, optionData };
